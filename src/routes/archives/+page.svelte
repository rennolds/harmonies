<script>
  ...
  if (
    ...
    (currentYear === LAUNCH_YEAR && currentMonth < LAUNCH_MONTH)
  ) {
  ...
  function nextMonth() {
    ...
    if (
      ...
      (newYear === CURRENT_YEAR && newMonth > CURRENT_MONTH)
    ) {
  ...
  function prevMonth() {
    ...
    if (
      newYear < LAUNCH_YEAR ||
      (newYear === LAUNCH_YEAR && newMonth < LAUNCH_MONTH)
    ) {
  ...
  $: isAtEarliestMonth =
    currentMonth === LAUNCH_MONTH && currentYear === LAUNCH_YEAR;
  $: isAtLatestMonth =
...
<div class="archive-page">
  ...
  <div class="archive-content">
    ...
    <div class="month-selector">
      ...
      >
        ...
        >
          <path
            d="M15 18L9 12L15 6"
            stroke={isAtEarliestMonth ? "#666" : "white"}
            stroke-width="2"
      ...
      <button on:click={nextMonth} class="month-btn" disabled={isAtLatestMonth}>
        ...
        >
          <path
            d="M9 18L15 12L9 6"
            stroke={isAtLatestMonth ? "#666" : "white"}
            stroke-width="2"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
    ...
    <Calendar {currentMonth} {currentYear} onSelectDate={handleDateSelect} />
  </div>
</div>
...
<style>
  ...
  .archive-page {
    ...
    min-height: 100vh;
    width: 100%;
    padding-top: 100px; /* Default padding for mobile (50px ad + 50px navbar) */
  }

  /* Adjust padding for desktop */
  @media (min-width: 768px) {
    .archive-page {
      padding-top: 50px; /* Only account for navbar height on desktop */
    }
  }
