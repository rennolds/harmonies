  ...
  <main>
    ...
    <div class="shoutout">
      ...
      <div class="shoutout-socials">
        <button>
          <a href="https://www.youtube.com/@theneedledrop" target="_blank">
        ...
        <button>
          <a href="https://twitter.com/theneedledrop" target="_blank">
        ...
        <button>
          <a href="https://www.tiktok.com/@theneedletok" target="_blank">
